        ...
        <div class="container pt-6 pt-md-10 pb-4">
                ...
                <div class="col-lg-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active fw-bold" aria-current="page">Surat Keterangan Berkelakuan Baik
                            </li>
                        </ol>
                    </nav>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mt-2">
                        <div class="card-body">
                            {{-- <div class="display-6">Surat Keterangan Berkelakuan Baik</div> --}}
                            <div class="classic-view">
                                <article class="post">
                                    <div class="post-content p-2" style="font-size: 12px;">
                                        <iframe
                                            src="https://docs.google.com/forms/d/e/1FAIpQLSf2Gaiwlq-W0rDyuERvbmOySQwGLDss5AX885v1nie2P7hzuA/viewform?embedded=true"
